function [fig1,fig2,fig3] = triplotter_vdp_tols(T,X,p)
T1 = T{1};
T2 = T{2};
T3 = T{3};
X1 = X{1};
...
fig1 = figure(1);
plot(nan, nan, 'LineStyle','none', "DisplayName", "atol:")
hold on
plot(T1,X1(:,1), "DisplayName", ['$$10^{' num2str(log10(p.abstol(1))) '}$$'] );
%hold on
plot(T2,X2(:,1), "DisplayName", ['$$10^{' num2str(log10(p.abstol(2))) '}$$'] );
plot(T3,X3(:,1), "DisplayName", ['$$10^{' num2str(log10(p.abstol(3))) '}$$'] );
hold off
pbaspect([1 1 1])
...
fig2 = figure(2);
plot(nan, nan, 'w', "DisplayName", "atol:")
hold on
plot(T1,X1(:,2), "DisplayName", ['$$10^{' num2str(log10(p.abstol(1))) '}$$'] );
hold on
plot(T2,X2(:,2), "DisplayName", ['$$10^{' num2str(log10(p.abstol(2))) '}$$'] );
plot(T3,X3(:,2), "DisplayName", ['$$10^{' num2str(log10(p.abstol(3))) '}$$']);
hold off
pbaspect([1 1 1])
legend('interpreter','latex','Location', 'northwest');
xlim([min(T1), max(T2)])
...
plot(nan, nan, 'LineStyle','none', "DisplayName", "atol:")
hold on
plot(X1(:,1),X1(:,2), "DisplayName", ['$$10^{' num2str(log10(p.abstol(1))) '}$$'] );
plot(X2(:,1),X2(:,2), "DisplayName", ['$$10^{' num2str(log10(p.abstol(2))) '}$$'] );
plot(X3(:,1),X3(:,2), "DisplayName", ['$$10^{' num2str(log10(p.abstol(3))) '}$$'] );
hold off
pbaspect([1 1 1])
legend('interpreter','latex','Location', 'northwest')
