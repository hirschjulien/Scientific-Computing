...
while t<tf
    ...
    while ~AcceptStep
        ...
        x1 = NewtonsMethodODE(FunJac, t, x, h, xinit, abstol, maxit, varargin{:});
        ...
        xm = NewtonsMethodODE(FunJac, t, x, hm, xinitm, abstol, maxit, varargin{:});
        fm = feval(FunJac, tm, xm, varargin{:}); % Function evaluated with half step
        x1hat = NewtonsMethodODE(FunJac, tm, xm, hm, xinit, abstol, maxit, varargin{:});
