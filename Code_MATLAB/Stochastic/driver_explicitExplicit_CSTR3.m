...
for i = 1:Ns
    ...
    X(:,:,i) = ExplicitExplicit(ffun, gfun, T, InitCond, W_i, p, u);
end
...
Xd = ExplicitExplicit(ffun, gfun, T, InitCond, W0, p_d, u);  % same functions, zero sigma
...
xlabel('Time [min]');
sgtitle('Stochastic CSTR3 with temperature noise only');
