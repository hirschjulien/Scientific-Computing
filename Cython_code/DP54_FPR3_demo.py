...
fig.suptitle('PFR (3 State Model) DP54 with Heatmaps', fontsize=20, fontweight='bold', color='#333333', y=1.05)
...
plt.tight_layout()
plt.savefig("DP54_PFR3.png")
plt.show()


# %%
def PFR_3state(t, y, argv):
...
result = solve_ivp(
    lambda t, y: PFR_3state(t, y, argv),
    t_span = t_range,
    y0 = x0,
    method='RK45',
    rtol=reps,          
